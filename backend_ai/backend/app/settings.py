...
class Settings(BaseSettings):
    ...
    ACCOUNT_LOGIN_SLOT_ATTEMPT_TIMEOUT_SEC: int = 180
    ACCOUNT_LOGIN_SLOT_HOLD_TTL_SEC: int = 300
    START_BOT_ACK_TIMEOUT_SEC: int = 120
    ACCOUNT_RUNTIME_START_GUARD_STALE_SEC: int = 180
    RUNNER_OFFLINE_FAILOVER_ENABLED: bool = True
    RUNNER_OFFLINE_FAILOVER_GRACE_SEC: int = 240
